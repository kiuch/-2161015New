...
evaluation_aspects = {
    "起承転結の明確性": {
        ...
        'positive_eval_words': ["納得", "しっかり", "整合性", "論理的", "完璧", "伏線", "見事", "熱い", "驚く", "予想外", "終盤", "整合性","魅力的", "感情移入", "個性的", "愛着", "最高", "活き活き", "丁寧", "良いキャラ", "好き","共感", "身近", "感動", "深い", "考えさせられる", "暖かい", "普遍的", "大切", "泣ける","没入感", "引き込まれる", "ワクワク", "楽しい", "自由度", "リアル", "雰囲気", "心躍る", "満喫"],
        'negative_eval_words': ["尻すぼみ", "矛盾", "不完全", "意味不明", "唐突", "陳腐", "薄い", "浅い", "稚拙", "破綻","弱い", "薄い", "平凡", "個性が", "魅力が", "共感", "中身がない", "面倒","浅い", "説教臭い", "物足りない", "響かない", "軽すぎ", "短すぎ", "表面上","単調", "退屈", "ストレス", "移動", "作業", "遠い", "変わらず", "バグ", "カクカク", "重い", "マップ"]
    },
    "キャラクターの魅力": {
